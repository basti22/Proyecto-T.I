...
<form class="form-horizontal" action="conexion_formularioagregarpersonal.php" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="" class="form-control" name="1name" placeholder="Ingrese el primer nombre">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Apellido Paterno:</label>
    <div class="col-sm-10">
      <input type="" class="form-control" name="1apellido" placeholder="Ingrese aellido paterno">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Apellido Materno:</label>
    <div class="col-sm-10">
      <input type="" class="form-control" name="2apellido" placeholder="Ingrese apellido materno">
    </div>
  </div>
  </div>
  <div class="form-group"> 
