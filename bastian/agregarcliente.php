...
<form class="form-horizontal" action="conexion_formularioagregarpersonal.php" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="" class="form-control" name="fname" placeholder="Ingrese el primer nombre">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd" >Segundo Nombre:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="mname" placeholder="Ingrese el segundo nombre">
    </div>
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Apellido Paterno:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="lname" placeholder="Ingrese apellido paterno">
    </div>
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Apellido Materno:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="sname" placeholder="Ingrese apellido materno">
    </div>
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="fono" placeholder="Ingrese numero de Telefono">
    </div>
  </div>
  <div class="form-group"> 
