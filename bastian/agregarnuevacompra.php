...
<form class="form-horizontal" action="conexion_formularioagregarpersonal.php" method="post">
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Nombre Proveedor:</label>
    <div class="col-sm-10">
      <input type="" class="form-control" name="fname" placeholder="Ingrese nombre proveedor">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd" >Producto:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="mname" placeholder="Ingrese producto comprado">
    </div>
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Cantidad:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="lname" placeholder="Ingrese cantidad comprada (en unidades)">
    </div>
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Total:</label>
    <div class="col-sm-10"> 
      <input type="" class="form-control" name="sname" placeholder="Ingrese valor total de la compra">
    </div>
  </div>
   <div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Fecha:</label>
    <div class="col-sm-10"> 
      <input type="date" class="form-control" name="date" placeholder="Ingrese fecha (año-mes-dia)">
    </div>
  </div>
  <div class="form-group"> 
