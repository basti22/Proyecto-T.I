...
$Nombre1 = $_POST['fname'];
$Nombre2 = $_POST['mname'];
$Apellido1 = $_POST['lname'];
$Apellido2 = $_POST['sname'];
...
$buscar = "INSERT INTO empleado (Rut, Nombre1, Nombre2, Apellido1, Apellido2, especialidad, Salario) VALUES ('$Rut','$Nombre1','$Nombre2',
  '$Apellido1','$Apellido2','$Especialidad','$Salario')";
